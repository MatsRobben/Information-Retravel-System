...
# to csv
collection.to_csv(r"C:\Users\Raul\Downloads\collection_10.csv", sep=',', index=False)
queries.to_csv(r"C:\Users\Raul\Downloads\queries_10.csv", sep=',', index=False)
qrel.to_csv(r"C:\Users\Raul\Downloads\qrel_10.csv", sep=',', index=False)